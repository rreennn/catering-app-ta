          ...
          >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:hello@nikitacatering.com"
                      className="text-slate-600 text-sm hover:text-orange-600 transition"
                    >
            ...
            <div className="mt-5 pt-5 border-t border-orange-200/50">
              ...
              <div className="flex justify-center gap-4">
                <a
                  href="#"
                  className="p-2 bg-white rounded-full text-slate-600 hover:text-pink-600 hover:shadow transition duration-200"
                >
                  <Instagram className="w-6 h-6" />
                </a>
                <a
                  href="#"
                  className="p-2 bg-white rounded-full text-slate-600 hover:text-blue-600 hover:shadow transition duration-200"
                >
          ...
          >
            <div className="absolute inset-0 overflow-hidden rounded-3xl">
              <iframe
                ...
                className="grayscale hover:grayscale-0 transition-all duration-500 absolute top-0"
              ></iframe>
            </div>
